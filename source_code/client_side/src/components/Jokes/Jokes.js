...
const Jokes = () => {
  ...
  const fetchJoke = async () => {
    ...
    try {
      ...
      const newJoke = response?.data.setup
    ...
    <div className="jokesContainer">
      ...
      <div className="form-group">
        ...
        >
          ...
          <option className="option" value="Programming">
            Programming
          </option>
          <option className="option" value="Miscellaneous">
            Miscellaneous
          </option>
          <option className="option" value="Pun">
            Pun
          </option>
        </select>
      </div>
      <Button variant="secondary" onClick={fetchJoke}>
        Fetch Joke
      </Button>
