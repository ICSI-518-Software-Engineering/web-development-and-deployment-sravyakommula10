...
const MyBlog = () => {
    const initialDescription = "Hello! I'm Sravya Kommula, currently pursuing MS in Computer Science at SUNY ALBANY."
    ...
    const handleSum = async () => {
        ...
        const payload = {
          method: "POST",
          url: "http://ec2-18-222-177-27.us-east-2.compute.amazonaws.com:5001/add",
                ...
                <Container className="userSection mb-5">
                    <Row>
                        ...
                        <Col sm={6}>
                            ...
                            <Button variant="secondary" className="editButton" onClick={handleEdit}>Edit</Button>
                            <Button variant="outline-success" className="updateButton" onClick={handleUpdate}>Update</Button>
                            <Button variant="outline-danger" className="cancelButton" onClick={handleCancel}>Cancel</Button>
                ...
                <Container className="mt-5">
                    ...
                    <Row>
                        ...
                        <Col>
                            ...
                            <h4 className={`output ${getOutputServerClass()}`}><strong>  Your addition Result (from server) is:  {serverSum}</strong></h4>
